...
public partial class MainViewModel
{
    ...
    public async Task CheckForUpdatesAsync(bool reportUpToDate)
    {
        ...
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("BSGroupGenerator");
            var json = await http.GetStringAsync("https://api.github.com/repos/lin-414/BSGroupGenerator/releases/latest");
